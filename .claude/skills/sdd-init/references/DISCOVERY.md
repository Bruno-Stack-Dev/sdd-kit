...
> Alimenta: `template-visao.md` (`sdd template show visao`), `template-requisitos.md` (`sdd template show requisitos`), `template-fluxos.md` (`sdd template show fluxos`).
...
## Bloco 2 — Dados
> Alimenta: `template-modelo-dados.md` (`sdd template show modelo-dados`).
...
> Alimenta: `template-arquitetura.md` (`sdd template show arquitetura`) (C4), `template-api.md` (`sdd template show api`), `template-rbac.md` (`sdd template show rbac`), e a base do
...
> Alimenta: `template-backlog.md` (`sdd template show backlog`) e a numeração de specs (config seção 4).
...
> Alimenta: `template-infra.md` (`sdd template show infra`) e defaults da config (seção 10).
...
1. **`specs/discovery/`** — gere um arquivo por template preenchido:
   - `VISAO.md` ← `template-visao.md` (`sdd template show visao`)
   - `REQUISITOS.md` ← `template-requisitos.md` (`sdd template show requisitos`)
   - `FLUXOS.md` ← `template-fluxos.md` (`sdd template show fluxos`)
   - `MODELO-DADOS.md` ← `template-modelo-dados.md` (`sdd template show modelo-dados`)
   - `ARQUITETURA.md` ← `template-arquitetura.md` (`sdd template show arquitetura`)
   - `API.md` ← `template-api.md` (`sdd template show api`) (só se houver API)
...
3. **`sdd.config.yaml`** (raiz) ← `sdd template show config`, preenchido com Blocos 3–5:
   ...
   `sdd config validate` e `sdd config render` (gera a visão
   `sdd.config.md`).
...
6. **Validar:** rode `sdd doctor --fast` e o comando de testes da config (se já houver
